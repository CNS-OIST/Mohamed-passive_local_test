...
df=pd.DataFrame(
    {"t":Vrs.time[0],"V(point1)":Vrs.data[0,:,0], "V(point2)":Vrs.data[0,:,1], "V(point3)":Vrs.data[0,:,2],"V(point4)":Vrs.data[0,:,3] }
)

df.to_csv("/Users/mohamedrashed/Desktop/rallpack_passive_local/file.txt",sep=",",index=False,)
